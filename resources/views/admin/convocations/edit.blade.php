...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.convocation.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.convocations.update", [$convocation->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label class="required" for="name">{{ trans('cruds.convocation.fields.name') }}</label>
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $convocation->name) }}" required>
                    @if($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $convocation->slug) }}">
                    @if($errors->has('slug'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('controller_of_examination') ? 'is-invalid' : '' }}" type="text" name="controller_of_examination" id="controller_of_examination" value="{{ old('controller_of_examination', $convocation->controller_of_examination) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('vice_chancellor') ? 'is-invalid' : '' }}" type="text" name="vice_chancellor" id="vice_chancellor" value="{{ old('vice_chancellor', $convocation->vice_chancellor) }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('is_active') ? 'is-invalid' : '' }}" name="is_active" id="is_active" required>
                        ...
                        @foreach(App\Models\Convocation::IS_ACTIVE_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('is_active', $convocation->is_active) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
