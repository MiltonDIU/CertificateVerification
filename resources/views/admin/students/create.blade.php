        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.students.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('student_id_no') ? 'is-invalid' : '' }}" type="text" name="student_id_no" id="student_id_no" value="{{ old('student_id_no', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('cgpa') ? 'is-invalid' : '' }}" type="text" name="cgpa" id="cgpa" value="{{ old('cgpa', '') }}" required>
                    @if($errors->has('cgpa'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('out_of_cgpa') ? 'is-invalid' : '' }}" type="text" name="out_of_cgpa" id="out_of_cgpa" value="{{ old('out_of_cgpa', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('certificate_generate_day_month') ? 'is-invalid' : '' }}" type="text" name="certificate_generate_day_month" id="certificate_generate_day_month" value="{{ old('certificate_generate_day_month', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('certificate_generate_year') ? 'is-invalid' : '' }}" type="text" name="certificate_generate_year" id="certificate_generate_year" value="{{ old('certificate_generate_year', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('result_published_date') ? 'is-invalid' : '' }}" type="text" name="result_published_date" id="result_published_date" value="{{ old('result_published_date', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('faculty_name') ? 'is-invalid' : '' }}" type="text" name="faculty_name" id="faculty_name" value="{{ old('faculty_name', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('program_name') ? 'is-invalid' : '' }}" type="text" name="program_name" id="program_name" value="{{ old('program_name', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('convocation_name') ? 'is-invalid' : '' }}" type="text" name="convocation_name" id="convocation_name" value="{{ old('convocation_name', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('convocation') ? 'is-invalid' : '' }}" name="convocation_id" id="convocation_id">
                        @foreach($convocations as $id => $entry)
                            <option value="{{ $id }}" {{ old('convocation_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
